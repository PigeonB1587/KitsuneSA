...
namespace Cysharp.Threading.Tasks
{
    ...
    {
        static readonly ContinuationQueue ThrowMarkerContinuationQueue = new(PlayerLoopTiming.Initialization);
        static readonly PlayerLoopRunner ThrowMarkerPlayerLoopRunner = new(PlayerLoopTiming.Initialization);
